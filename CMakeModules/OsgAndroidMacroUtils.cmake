...
MACRO(ANDROID_3RD_PARTY)
    ...
    FIND_PATH(JPEG_INCLUDE_DIR jpeglib.h
        ${CMAKE_SOURCE_DIR}/3rdparty/libjpeg/include NO_CMAKE_FIND_ROOT_PATH
    )
    if(JPEG_INCLUDE_DIR)
        message(STATUS "Jpeg found ${JPEG_INCLUDE_DIR}" )
        set(JPEG_FOUND "Yes")
        install(DIRECTORY 3rdparty/libjpeg/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    ...
    FIND_PATH(PNG_INCLUDE_DIR png.h
        ${CMAKE_SOURCE_DIR}/3rdparty/libpng/include NO_CMAKE_FIND_ROOT_PATH
    )
    if(PNG_INCLUDE_DIR)
        message(STATUS "PNG found ${PNG_INCLUDE_DIR}" )
        set(PNG_FOUND "Yes")
        install(DIRECTORY 3rdparty/libpng/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    ...
    FIND_PATH(GIFLIB_INCLUDE_DIR gif_lib.h
        ${CMAKE_SOURCE_DIR}/3rdparty/giflib/include NO_CMAKE_FIND_ROOT_PATH
    )
    if(GIFLIB_INCLUDE_DIR)
        message(STATUS "GIF found ${GIFLIB_INCLUDE_DIR}" )
        set(GIFLIB_FOUND "Yes")
        install(DIRECTORY 3rdparty/giflib/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    ...
    FIND_PATH(TIFF_INCLUDE_DIR tiff.h
        ${CMAKE_SOURCE_DIR}/3rdparty/libtiff/include NO_CMAKE_FIND_ROOT_PATH
    )
    ...
    if(TIFF_INCLUDE_DIR)
        ...
        set(TIFF_FOUND "Yes")
        install(DIRECTORY 3rdparty/libtiff/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    ...
    #ZLIB
    ################################################
    #FIND_PATH(ZLIB_INCLUDE_DIR zlib.h PATHS ${CMAKE_SOURCE_DIR}/3rdparty/zlib/include NO_CMAKE_FIND_ROOT_PATH)
    #if(ZLIB_INCLUDE_DIR)
    #    message(STATUS "ZLIB found ${ZLIB_INCLUDE_DIR}" )
    #    set(ZLIB_FOUND "Yes")
    #    install(DIRECTORY 3rdparty/zlib/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    ...
    FIND_PATH(CURL_DIR curl.h
        ${CMAKE_SOURCE_DIR}/3rdparty/curl/include NO_CMAKE_FIND_ROOT_PATH
    )
    ...
    if(CURL_DIR)
        ...
        set(CURL_FOUND "Yes")
        install(DIRECTORY 3rdparty/curl/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    else(CURL_DIR)
    ...
    FIND_PATH(FREETYPE_DIR ft2build.h
        ${CMAKE_SOURCE_DIR}/3rdparty/freetype/include/freetype2 NO_CMAKE_FIND_ROOT_PATH
    )
    set(FREETYPE_INCLUDE_DIRS ${FREETYPE_DIR} ${FREETYPE_DIR}/freetype/config)
    if(FREETYPE_DIR)
        message(STATUS "FREETYPE found ${FREETYPE_DIR}" )
        set(FREETYPE_FOUND "Yes")
        install(DIRECTORY 3rdparty/freetype/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    else(FREETYPE_DIR)
    ...
    if(GDAL_DIR)
        ...
        set(GDAL_FOUND "Yes")
        install(DIRECTORY 3rdparty/gdal/lib/${ANDROID_ABI}/ DESTINATION ./lib/third-party )
    else(GDAL_DIR)
