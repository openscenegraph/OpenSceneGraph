...
MACRO(SETUP_LIBRARY LIB_NAME)
    ...
    ENDIF()
        ...
        IF(APPLE)
            ...
            IF(${IPHONE_ENABLE_BITCODE} STREQUAL "YES")
                set_target_properties(${LIB_NAME} PROPERTIES XCODE_ATTRIBUTE_ENABLE_BITCODE "YES")
            ELSE()
                set_target_properties(${LIB_NAME} PROPERTIES XCODE_ATTRIBUTE_ENABLE_BITCODE "NO")
            ENDIF()
...
MACRO(SETUP_PLUGIN PLUGIN_NAME)
    ...
    IF(APPLE)
        ...
        IF(${IPHONE_ENABLE_BITCODE} STREQUAL "YES")
            set_target_properties(${TARGET_TARGETNAME} PROPERTIES XCODE_ATTRIBUTE_ENABLE_BITCODE "YES")
        ELSE()
            set_target_properties(${TARGET_TARGETNAME} PROPERTIES XCODE_ATTRIBUTE_ENABLE_BITCODE "NO")
        ENDIF()
