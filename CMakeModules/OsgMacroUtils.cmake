...
MACRO(SETUP_APPLICATION APPLICATION_NAME)
        ...
        ELSE(APPLE)
            ...
            IF(MSVC)
                INSTALL(FILES ${CMAKE_BINARY_DIR}/bin/${TARGET_TARGETNAME}${CMAKE_RELWITHDEBINFO_POSTFIX}.pdb DESTINATION bin COMPONENT openscenegraph CONFIGURATIONS RelWithDebInfo)
                INSTALL(FILES ${CMAKE_BINARY_DIR}/bin/${TARGET_TARGETNAME}${CMAKE_DEBUG_POSTFIX}.pdb DESTINATION bin COMPONENT openscenegraph CONFIGURATIONS Debug)
            ENDIF(MSVC)
        ENDIF(APPLE)
...
MACRO(SETUP_EXAMPLE EXAMPLE_NAME)
        ...
        ELSE(APPLE)
            ...
            IF(MSVC)
                INSTALL(FILES ${CMAKE_BINARY_DIR}/bin/${TARGET_TARGETNAME}${CMAKE_RELWITHDEBINFO_POSTFIX}.pdb DESTINATION share/OpenSceneGraph/bin COMPONENT openscenegraph-examples CONFIGURATIONS RelWithDebInfo)
                INSTALL(FILES ${CMAKE_BINARY_DIR}/bin/${TARGET_TARGETNAME}${CMAKE_DEBUG_POSTFIX}.pdb DESTINATION share/OpenSceneGraph/bin COMPONENT openscenegraph-examples CONFIGURATIONS Debug)
            ENDIF(MSVC)
        ENDIF(APPLE)
