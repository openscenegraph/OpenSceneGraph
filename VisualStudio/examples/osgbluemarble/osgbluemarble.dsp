...
# ADD LINK32 opengl32.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"../../../bin/osgbluemarble.exe" /libpath:"../../../lib"
...
# ADD LINK32 opengl32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libcmt" /out:"../../../bin/osgbluemarbled.exe" /pdbtype:sept /libpath:"../../../lib"
