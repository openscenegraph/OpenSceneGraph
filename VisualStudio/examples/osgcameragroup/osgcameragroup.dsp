...
# ADD LINK32 opengl32.lib Producer.lib OpenThreadsWin32.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"../../../bin/osgcameragroup.exe" /libpath:"../../../lib"
...
# ADD LINK32 opengl32.lib Producerd.lib OpenThreadsWin32d.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libcmt" /out:"../../../bin/osgcameragroupd.exe" /pdbtype:sept /libpath:"../../../lib"
