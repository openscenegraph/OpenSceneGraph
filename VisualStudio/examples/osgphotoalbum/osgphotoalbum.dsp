...
# ADD LINK32 /nologo /subsystem:console /pdb:none /machine:I386 /out:"../../../bin/osgphotoalbum.exe" /libpath:"../../../lib"
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libcmt" /out:"../../../bin/osgphotoalbumd.exe" /pdbtype:sept /libpath:"../../../lib"
