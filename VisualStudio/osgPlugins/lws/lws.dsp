...
!MESSAGE "osgPlugin lws - Win32 Release Static" (based on "Win32 (x86) Static Library")
!MESSAGE "osgPlugin lws - Win32 Debug Static" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
# ADD LINK32 OpenThreadsWin32.lib glu32.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /opt:ref /opt:icf /out:"$(OutDir)/osgdb_lws.dll" /implib:"../../../lib/$(PlatformName)/osgdb_lws.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsWin32d.lib glu32.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_lwsd.dll" /pdbtype:sept /implib:"../../../lib/$(PlatformName)/osgdb_lwsd.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "osgPlugin lws - Win32 Release Static"
...
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_lws_s.lib"
# SUBTRACT LIB32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin lws - Win32 Debug Static"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_lwsd_s.lib"
# SUBTRACT LIB32 /nodefaultlib
...
# Name "osgPlugin lws - Win32 Release Static"
# Name "osgPlugin lws - Win32 Debug Static"
