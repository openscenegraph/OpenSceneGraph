# Microsoft Developer Studio Project File - Name="osgPlugin net" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "net.mak" CFG="osgPlugin net - Win32 Debug"
!MESSAGE 
...
!IF  "$(CFG)" == "osgPlugin net - Win32 Release"
...
# PROP Target_Dir ""
F90=df.exe
# ADD BASE CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OSGPLUGINNET_EXPORTS" /YX /FD /c
...
# ADD LINK32 OpenThreadsWin32.lib wsock32.lib /nologo /dll /debug /machine:I386 /opt:ref /opt:icf /out:"$(OutDir)/osgdb_net.dll" /implib:"../../../lib/$(PlatformName)/osgdb_net.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"

!ELSEIF  "$(CFG)" == "osgPlugin net - Win32 Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "osgPlugin_net___Win32_Debug"
# PROP BASE Intermediate_Dir "osgPlugin_net___Win32_Debug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
...
# PROP Target_Dir ""
F90=df.exe
# ADD BASE CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OSGPLUGINNET_EXPORTS" /YX /FD /GZ /c
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsWin32d.lib wsock32.lib /nologo /dll /debug /machine:I386 /out:"$(OutDir)/osgdb_netd.dll" /pdbtype:sept /implib:"../../../lib/$(PlatformName)/osgdb_netd.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
...
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_net_s.lib"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_netd_s.lib"
# SUBTRACT LIB32 /nodefaultlib
