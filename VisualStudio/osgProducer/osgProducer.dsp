...
# ADD LINK32 producer.lib glu32.lib opengl32.lib /nologo /dll /pdb:none /machine:I386 /out:"../../bin/osgProducer.dll" /libpath:"../../lib"
...
# ADD LINK32 producer.lib glu32.lib opengl32.lib /nologo /dll /debug /machine:I386 /out:"../../bin/osgProducerd.dll" /pdbtype:sept /libpath:"../../lib"
