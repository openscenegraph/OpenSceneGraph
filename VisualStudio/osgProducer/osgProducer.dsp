...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../../include" /I "../../../OpenThreads/include" /I "../../../Producer/include" /I "../../../3rdParty/include" /D "NDEBUG" /D "_MBCS" /D "_USRDLL" /D "OSGPRODUCER_LIBRARY" /D "WIN32" /D "_WINDOWS" /YX /FD /Zm200 /c
...
# ADD LINK32 OpenThreadsWin32.lib opengl32.lib glu32.lib producer.lib /nologo /dll /pdb:none /machine:I386 /out:"../../bin/osgProducer.dll" /libpath:"../../lib" /libpath:"../../../OpenThreads/lib/win32" /libpath:"../../../Producer/lib" /libpath:"../../../3rdParty/lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /vmg /GR /GX /Zi /Od /I "../../include" /I "../../../OpenThreads/include" /I "../../../Producer/include" /I "../../../3rdParty/include" /D "OSGPRODUCER_LIBRARY" /D "_WINDOWS" /D "WIN32" /D "_DEBUG" /YX /FD /GZ /Zm200 /c
...
# ADD LINK32 OpenThreadsWin32d.lib opengl32.lib glu32.lib producerd.lib /nologo /dll /debug /machine:I386 /out:"../../bin/osgProducerd.dll" /pdbtype:sept /libpath:"../../lib" /libpath:"../../../OpenThreads/lib/win32" /libpath:"../../../Producer/lib" /libpath:"../../../3rdParty/lib"
...
# ADD LIB32 /nodefaultlib /nologo /out:"../../lib/osgProducer_s.lib"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"../../lib/osgProducerd_s.lib"
