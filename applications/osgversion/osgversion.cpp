...
std::string typoCorrection(const std::string& name)
{
    ...
    if (name=="Sokolowky") return "Sokolowsky";
    ...
    if (name=="Amueller") return "Aumueller";
...
{
    if (name.first=="Marc" && name.second=="Sciabica")
    {
        name.first = "Mark";
        name.second = "Sciabica";
    }
    
    if (name.first=="Jean" && name.second=="Sebastien")
    {
        name.first = "Jean-Sebastien";
        name.second = "Guay";
    }
