...
GL2Extensions::GL2Extensions(const GL2Extensions& rhs) : osg::Referenced()
{
	...
	_glBeginTransformFeedback=rhs._glBeginTransformFeedback;
	_glEndTransformFeedback=rhs._glEndTransformFeedback;
    _glDeleteVertexArrays=rhs._glDeleteVertexArrays;
    _glGenVertexArrays=rhs._glGenVertexArrays;
    _glIsVertexArray=rhs._glIsVertexArray;
    _glBindVertexArray=rhs._glBindVertexArray;
...
void GL2Extensions::lowestCommonDenominator(const GL2Extensions& rhs)
{
	...
	if(!rhs._glTransformFeedbackVaryings)_glTransformFeedbackVaryings=0;
	if(!rhs._glBeginTransformFeedback)_glBeginTransformFeedback=0;
	if(!rhs._glEndTransformFeedback)_glEndTransformFeedback=0;
    if(!rhs._glEndTransformFeedback)  _glDeleteVertexArrays=rhs._glDeleteVertexArrays;
    if(!rhs._glGenVertexArrays)_glGenVertexArrays=rhs._glGenVertexArrays;
    if(!rhs._glIsVertexArray)_glIsVertexArray=rhs._glIsVertexArray;
    if(!rhs._glBindVertexArray) _glBindVertexArray=rhs._glBindVertexArray;
...
_glBeginTransformFeedback=0;
_glEndTransformFeedback=0;
  _glDeleteVertexArrays=0;
_glGenVertexArrays=0;
_glIsVertexArray=0;
 _glBindVertexArray=0;
	...
	setGLExtensionFuncPtr(_glTransformFeedbackVaryings, "glTransformFeedbackVaryings", "glTransformFeedbackVaryingsARB");
	setGLExtensionFuncPtr(_glBeginTransformFeedback, "glBeginTransformFeedback", "glBeginTransformFeedbackARB");
	setGLExtensionFuncPtr(_glEndTransformFeedback, "glEndTransformFeedback", "glEndTransformFeedbackARB");
	setGLExtensionFuncPtr(_glDeleteVertexArrays, "glDeleteVertexArrays", "glDeleteVertexArraysARB");
	setGLExtensionFuncPtr(_glGenVertexArrays, "glGenVertexArrays", "glGenVertexArraysARB");
  	setGLExtensionFuncPtr(_glIsVertexArray, "glIsVertexArray", "glIsVertexArrayARB");
...
void GL2Extensions::glTransformFeedbackVaryings(GLuint program,  GLsizei count,  const char **varyings,  GLenum bufferMod) const
{
	if (_glTransformFeedbackVaryings)
	{

		_glTransformFeedbackVaryings(program,count,varyings,bufferMod);
	}
	else
	{
		NotSupported( "glTransformFeedbackVaryings" );
	}
}
...
void GL2Extensions::glDeleteVertexArrays ( GLsizei size,const GLuint *handles ) const
{
	if (_glDeleteVertexArrays )
	{

		_glDeleteVertexArrays (size,handles);
	}
	else
	{
		NotSupported( "glDeleteVertexArrays " );
	}
}

void GL2Extensions::glGenVertexArrays (GLsizei size, GLuint *handles) const
{
	if (_glGenVertexArrays )
	{

		_glGenVertexArrays (size,handles);
	}
	else
	{
...
void GL2Extensions::glBindVertexArray (GLuint handle) const
{
	if (_glBindVertexArray )
	{

		_glBindVertexArray ( handle);
	}
	else
	{
...
GLboolean GL2Extensions::glIsVertexArray (GLuint handle) const
{
	if (_glIsVertexArray )
	{

		return _glIsVertexArray (handle);
	}
	else
	{
		NotSupported( "glIsVertexArray " );
		return 0;
	}
}
