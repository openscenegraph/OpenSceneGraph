...
void State::resetVertexAttributeAlias(bool compactAliasing)
{
    ...
    if (compactAliasing)
    {
        ...
        setUpVertexAttribAlias(_normalAlias, 1, "gl_Normal","osg_Normal","vec3 ");
        setUpVertexAttribAlias(_colorAlias, 2, "gl_Color","osg_Color","vec4 ");
        ...
        for(unsigned int i=0; i<_texCoordAliasList.size(); i++)
        {
            ...
            setUpVertexAttribAlias(_texCoordAliasList[i], 3+i, gl_MultiTexCoord.str(), osg_MultiTexCoord.str(), "vec4 ");
        }

        setUpVertexAttribAlias(_secondaryColorAlias, 6, "gl_SecondaryColor","osg_SecondaryColor","vec4 ");
        setUpVertexAttribAlias(_fogCoordAlias, 7, "gl_FogCoord","osg_FogCoord","float ");
    ...
    else
    {
        ...
        for(unsigned int i=0; i<_texCoordAliasList.size(); i++)
        {
            ...
            setUpVertexAttribAlias(_texCoordAliasList[i], 8+i, gl_MultiTexCoord.str(), osg_MultiTexCoord.str(), "vec4 ");
        }
    }
}
