...
protected:
    ...
    struct StateSetInfo
    {
        StateSetInfo(osg::StateSet * in_stateset=NULL, Lib3dsMaterial * in_lib3dsmat=NULL) : stateset(in_stateset), lib3dsmat(in_lib3dsmat) {}
...
ReaderWriter3DS::ReaderObject::ReaderObject(const osgDB::ReaderWriter::Options* in_options) :
