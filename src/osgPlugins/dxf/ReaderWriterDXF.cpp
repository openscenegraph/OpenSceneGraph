...
public:
    ReaderWriterdxf()
    {
        ...
        supportsOption("WideChar", "Use wide byte strings to express text");
    ...
    if (options) {
...

        {
            ...
            while (iss >> opt)
            {
                ...
                else if(pre_equals=="WideChar")
                    dynamic_cast<dxfText*>(dxfEntity::getRegistryEntity("TEXT"))->setUseWideChar(true);
            }
        }
    } // options exist
