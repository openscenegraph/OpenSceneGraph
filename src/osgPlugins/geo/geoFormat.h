...
//#include "geoCore.h" // cunningly not suplied by Carbon Graphics.
...
const unsigned int DB_DSK_BILLBOARD                        = 103;
...
/*  these parameters set by Carbon Graphics, not needed for OSG loader
