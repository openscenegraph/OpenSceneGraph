    ...
    if (selectLight)
    {
        ...
        else
        {
            ...
            else    // directional light
            {
                ...
                osg::Vec3 selLightDir(lightpos.x(), lightpos.y(), lightpos.z());
                selLightDir.normalize();

                // set the position far away along the light direction
                osg::Vec3 position = bb.center() + selLightDir * bb.radius() * 2;
                ...
                _camera->setViewMatrixAsLookAt(position,bb.center(),computeOrthogonalVector(selLightDir));
            }
