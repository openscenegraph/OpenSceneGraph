char osgText_Text_frag[] = "$OSG_GLSL_VERSION\n"
                           ...
                           "    \n"
                           "    #ifdef OUTLINE\n"
                           "        float a0 = vertexColor.a * color_coeff.x;\n"
                           "        float a1 = BACKDROP_COLOR.a * color_coeff.y;\n"
                           "        float total_a = a0 + a1;\n"
                           "\n"
                           "        if (total_a <= 0.0) return vec4(0.0, 0.0, 0.0, 0.0);\n"
                           "\n"
                           "        return vec4(vertexColor.rgb * (a0 / total_a) + BACKDROP_COLOR.rgb * (a1 / total_a), total_a);\n"
                           "    #else\n"
